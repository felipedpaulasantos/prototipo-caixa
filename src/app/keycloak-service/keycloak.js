...
(function (window, undefined) {
    ...
    var Keycloak = function (config) {
        if (this === undefined) {
            // console.log("Keycloak", this);
            var modal = document.querySelector('.modal-sso');
                        ...
                        req.onreadystatechange = function () {
                            if (req.readyState == 4) {
                                if (req.status == 200) {
                                    ...
                                    console.error('[SSO] Failed to refresh token');
                                    // alert('[SSO] Token expirado, realize o login novamente.');
                                    var loading = document.querySelector('#exampleModal');
