export const dtLanguageDefinitionPt = {
    ...
    search: `<i class="fa fa-search fa-md mr-2"></i>`,
...
export class DataTableButtons {
    ...
    static readonly PRINT = new DataTableButtons(
        { extend: "print", className: "btn btn-outline-accent" }
    );

    static readonly EXCEL = new DataTableButtons(
        { extend: "excel", className: "btn btn-outline-accent" }
    );

    static readonly COPY = new DataTableButtons(
        { extend: "copy", className: "btn btn-outline-accent" }
    );

    static readonly COLVIS = new DataTableButtons(
        { extend: "colvis", className: "btn btn-outline-accent" }
    );
}
...
export class DataTableConfig {
    ...
    static BTN_CLASS = "btn btn-outline-aux";
