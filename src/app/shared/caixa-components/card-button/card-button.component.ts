...
export class CardButtonComponent implements OnInit, ControlValueAccessor {
  ...
  */
  ...
  /**
   * @param leftIconSize Classe do tamanho do ícone a ser exibido do lado esquerdo, ex: "fa-sm". Padrão: "fa-3x"
   * @type string
  */
   @Input()
   leftIconSize = "fa-3x";
  ...
  */
  ...
  /**
   * @param styles Objeto de estilo a ser passado para o card-button-left-side. Ex: [styles]="{ height: '300px'; font-color: 'blue' }"
   * @type object
  */
  @Input()
  leftSideStyles: { [klass: string]: any; } | string;

  /**
   * @param styles Objeto de estilo a ser passado para o card-button-right-side. Ex: [styles]="{ height: '300px'; font-color: 'blue' }"
   * @type object
  */
  @Input()
  rightSideStyles: { [klass: string]: any; } | string;
  ...
  */
  ...
  /**
   * @param {string} checked Define novo valor para a propriedade [leftIconSize].
  */
   setLeftIconSize(size: string) {
